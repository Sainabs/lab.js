...
/*
  ...
  create code that will check if Amy or Brittani is older, and 
  then console.log '{name} is older'. 
...
/*
  Using an if statement and a comparison operator, 
  create code that will log a suggestion on what type of clothes one should wear
  ...
  Come up with your own clothing suggestions based on those temperature 
